import { acceptPdf, acceptRss, rssUrl } from "./constants.mjs";
import {
 ...
 * @property {import("../types/services.ts").LoadPageService} loadPageService
...
export class DefaultRecallbotService {
  ...
  async _post(feedItem) {
    ...
    const dom = await this._deps.loadPageService.loadPage(feedItem.link);
