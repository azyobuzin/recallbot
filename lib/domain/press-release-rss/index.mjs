...
import { decodeShiftJIS } from "../../decode.mjs";
import { AcceptHeaderValue } from "../../infrastructures/index.mjs";

/** @type {import("./types.ts").DownloadPressReleaseRssFactory} */
...
/** @type {import("./types.ts").RetrieveRecallPressReleaseFeedItemsFactory} */
