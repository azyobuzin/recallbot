...
/**
 * @typedef DefaultExtractRecallDetailsFromPdfServiceDependencies
...
export class DefaultExtractRecallDetailsFromPdfService {
  /**
   * @param {DefaultExtractRecallDetailsFromPdfServiceDependencies} deps
   */
  constructor(deps) {
    this._deps = deps;
  }
  ...
  static createDefault() {
    ...
    return new DefaultExtractRecallDetailsFromPdfService({
